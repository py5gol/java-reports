...
<div style="padding: 1px; background-color: #eff0e2;">
    ...
    <c:forEach items="${requestScope.consulta}" var="rel" step="1"
        ...
        <tr>
            ...
            <a href="javascript:subrel('${rel.idRelatorio}')">Sub-relatórios</a>&nbsp;&nbsp;
            <a href="javascript:param('${rel.idRelatorio}')">Par&acirc;metros</a>&nbsp;&nbsp;
            <a href="javascript:editar('${rel.idRelatorio}')">Editar</a>&nbsp;&nbsp;
